 ...
 */
package com.steffen.EuroCalc.ocrreader.ui.camera;
...
public class GraphicOverlay<T extends GraphicOverlay.Graphic> extends View {
    ...
    public void textToTextView(String data, Context mContext) {
        TextView textView = (TextView) ((OcrCaptureActivity) mContext).findViewById(R.id.outPut);
